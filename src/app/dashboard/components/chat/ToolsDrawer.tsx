            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="dashboard-scrollbar absolute bottom-full left-0 mb-3 w-full sm:w-[400px] bg-white rounded-2xl shadow-2xl border border-gray-100 z-[110] origin-bottom-left max-h-[75vh] overflow-y-auto"
                    >
