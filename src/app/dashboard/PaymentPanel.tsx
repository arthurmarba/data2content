      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-baseline justify-center space-x-1 text-brand-dark mt-2">
              ...
              <span className="text-6xl font-extrabold tracking-tight leading-none text-brand-pink">19,90</span>
        ...
        <motion.button
          ...
          aria-label="Assinar o plano Data2Content Completo por R$19,90 por mês"
        >
          {loading ? (
