...
function mapDiagnosisDoc(doc: any): CreatorVideoNarrativeDiagnosisDocument {
  return {
    ...
    hookRecommendation: doc.hookRecommendation,
    hookSelection: doc.hookSelection,
    scriptAdjustmentRecommendation: doc.scriptAdjustmentRecommendation,
    scriptAdjustmentSelection: doc.scriptAdjustmentSelection,
    scriptAdjustmentExperimentCohort: doc.scriptAdjustmentExperimentCohort,
    analysisVersion: doc.analysisVersion,
    learningStatus: doc.learningStatus,
    historyVisibility: doc.historyVisibility,
