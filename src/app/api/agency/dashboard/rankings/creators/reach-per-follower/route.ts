...
// AVISO: A correção completa deste arquivo pode depender da atualização da função 'fetchReachPerFollowerCreators'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const results = await fetchReachPerFollowerCreators({ ...params, agencyId: session.user.agencyId } as any);
