...
function toPlannerSlotData(slot: PlannerUISlot | null): PlannerSlotDataModal | null {
  ...
  return {
    ...
    contentIntent: (slot as any).contentIntent,
    narrativeForm: (slot as any).narrativeForm,
    contentSignals: (slot as any).contentSignals,
    stance: (slot as any).stance,
    proofStyle: (slot as any).proofStyle,
    commercialMode: (slot as any).commercialMode,
...
function fromPlannerSlotData(data: PlannerSlotDataModal): PlannerUISlot {
  return {
    ...
    narrativeForm: data.narrativeForm ?? [],
