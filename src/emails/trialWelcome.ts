export function trialWelcomeEmail({
  ...
  const html = `
  <p>${greeting}</p>
  <p>Você acabou de liberar o <strong>Modo PRO</strong> da Data2Content por 48 horas. Durante esse período, além da comunidade aberta, você também tem acesso completo ao <strong>Grupo VIP</strong>: mentorias estratégicas semanais, salas reservadas e alertas premium no WhatsApp.</p>
  <p>Comece por aqui:</p>
  <ul>
