...
// AVISO: A correção completa deste arquivo pode depender da atualização da função 'fetchTopInteractionCreators'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const results = await fetchTopInteractionCreators({ ...params, agencyId: session.user.agencyId } as any);
