...
const ISSUE_CODE_MAP: Record<string, VideoNarrativeRealAnalysisUserFacingErrorCode> = {
  ...
  gemini_quota_exhausted: "gemini_provider_unavailable",
  gemini_permission_denied: "gemini_provider_unavailable",
  gemini_file_upload_failed: "storage_not_ready",
  gemini_file_permission_denied: "gemini_provider_unavailable",
  gemini_file_processing_failed: "storage_not_ready",
  gemini_file_processing_timeout: "storage_not_ready",
  gemini_file_uri_missing: "storage_not_ready",
  openai_fallback_failed: "gemini_provider_unavailable",
  openai_fallback_api_key_missing: "gemini_provider_unavailable",
  openai_fallback_video_missing: "storage_not_ready",
  openai_fallback_media_unavailable: "invalid_media",
  openai_fallback_media_processing_failed: "invalid_media",
  openai_fallback_media_timeout: "gemini_timeout",
  openai_fallback_frames_missing: "video_evidence_missing",
  openai_fallback_aborted: "gemini_timeout",
