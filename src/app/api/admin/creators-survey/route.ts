...
import { listCreatorSurveyResponses } from '@/lib/services/adminCreatorSurveyService';
...
export async function GET(req: NextRequest) {
  const TAG = '[api/admin/creators-survey][GET]';
  try {
    ...
    const filters: AdminCreatorSurveyListParams = {
      ...parseResult.data,
    ...
    const data = await listCreatorSurveyResponses(filters);
