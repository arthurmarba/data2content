...
// AVISO: A correção completa deste arquivo pode depender da atualização da função 'fetchPerformanceConsistencyCreators'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const results = await fetchPerformanceConsistencyCreators({ ...params, agencyId: session.user.agencyId } as any);
