...
const UserDetailView: React.FC<UserDetailViewProps> = ({
  ...
  // Todos os componentes internos utilizam o período definido pelo filtro global
  // através do hook useGlobalTimePeriod. Assim eles são atualizados automaticamente
  // quando o usuário altera o período na página principal.
    ...
    <div className="p-1 md:p-2 mt-8 border-t-2 border-indigo-500 pt-6">
      ...
      <section id={`user-performance-highlights-${userId}`} className="mb-10">
        <UserPerformanceHighlights
          ...
          initialTimePeriod={globalTimePeriod}
        />
      </section>
