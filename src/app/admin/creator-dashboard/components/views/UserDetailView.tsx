...
import React, { useState } from 'react'; // Adicionado useState para o seletor de período dos KPIs
...
import UserComparativeKpi from '../kpis/UserComparativeKpi'; // Importado
...
// Opções para o seletor de período de comparação dos KPIs
...
const UserDetailView: React.FC<UserDetailViewProps> = ({
  ...
  return (
    <div className="p-1 md:p-2 mt-8 border-t-2 border-indigo-500 pt-6">
      ...
      {/* Seção de Tendências da Conta do Criador */}
