...
4. **Pureza Técnica**: Nesta fase inicial, não há persistência em banco de dados, chamadas de OpenAI, UI ou integração com endpoints. O módulo é 100% focado em lógica de negócio pura e testável.
...
- [ ] Exibir blocos narrativos e diagnósticos na tela final do board.
