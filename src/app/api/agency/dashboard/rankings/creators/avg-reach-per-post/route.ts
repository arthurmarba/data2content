...
// AVISO: A correção completa deste arquivo pode depender da atualização da função 'fetchAvgReachPerPostCreators'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const results = await fetchAvgReachPerPostCreators({ ...params, agencyId: session.user.agencyId } as any);
