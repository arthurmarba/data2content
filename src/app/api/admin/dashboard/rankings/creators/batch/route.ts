/**
 * @fileoverview API Endpoint for fetching multiple creator rankings in a single request.
 */
...
const SERVICE_TAG = '[api/admin/dashboard/rankings/creators/batch]';
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const [
      ...
      fetchTopEngagingCreators(params),
      fetchTopInteractionCreators(params),
      fetchAvgEngagementPerPostCreators(params),
      fetchEngagementVariationCreators(params),
      fetchPerformanceConsistencyCreators(params),
      fetchMostProlificCreators(params),
      fetchTopSharingCreators(params),
      fetchAvgReachPerPostCreators(params),
      fetchReachPerFollowerCreators(params),
    ]);
