export function subscriptionCanceledEmail({
  ...
  const subject = "Assinatura do Plano Pro cancelada — acesso disponível até o fim do ciclo";

  const text = [
    `${greeting}`,
    "",
    `Recebemos o cancelamento da sua assinatura do Plano Pro. Você mantém o acesso até ${formattedEnd}.`,
    "",
  ...
  const html = `
    <p>${greeting}</p>
    <p>Recebemos o cancelamento da sua assinatura do Plano Pro. Você mantém o acesso até <strong>${formattedEnd}</strong>.</p>
