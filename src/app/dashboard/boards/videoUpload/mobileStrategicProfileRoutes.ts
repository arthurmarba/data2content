export { CREATOR_PROFILE_ROUTE } from "@/constants/routes";

/** Rota legada do shell mobile. Novos retornos devem usar CREATOR_PROFILE_ROUTE. */
...
export const MOBILE_STRATEGIC_MAP_ROUTE = "/dashboard/strategic-map";
export const MOBILE_MEDIA_KIT_ROUTE = "/dashboard/media-kit";
export const MOBILE_WHATSAPP_CONNECT_ROUTE = "/planning/whatsapp";
