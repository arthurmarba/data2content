  ...
  return (
    <section id="creator-rankings" className="mb-10">
      ...
      <div className="space-y-8">
        <div>
          <h4 className="text-sm font-semibold text-gray-600 mb-2">Engajamento</h4>
        ...
        <div>
          <h4 className="text-sm font-semibold text-gray-600 mb-2">Atividade</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <CreatorRankingCard
              title="Mais Posts"
        ...
        <div>
          <h4 className="text-sm font-semibold text-gray-600 mb-2">Alcance & Crescimento</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <CreatorRankingCard
        ...
        <div>
          <h4 className="text-sm font-semibold text-gray-600 mb-2">Destaques</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <TopCreatorsWidget
              title="Top Criadores"
