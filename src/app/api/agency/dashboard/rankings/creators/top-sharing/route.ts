...
// AVISO: A correção completa deste arquivo pode depender da atualização da função 'fetchTopSharingCreators'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const results = await fetchTopSharingCreators({ ...params, agencyId: session.user.agencyId } as any);
