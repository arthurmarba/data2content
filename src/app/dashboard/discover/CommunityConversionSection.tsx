        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-500">
              {paymentPending
                ? "Conclua o pagamento para liberar a comunidade, Instagram e 10 leituras por mês."
                : planActive
                  ? "Clique para entrar agora no WhatsApp e acompanhar a agenda da reunião semanal."
                  : "Toda semana a comunidade se reúne ao vivo pra ler conteúdo junto — análise de conteúdo e estratégia de imagem, criador a criador."}
            </p>
            ...
            {mentorshipData?.nextSessionLabel ? (
              <div className="mt-3">
                <span className="inline-flex min-w-0 items-center gap-1.5 rounded-full bg-indigo-50/70 px-3 py-1.5 text-[11px] font-semibold text-indigo-700 ring-1 ring-inset ring-indigo-100">
                  ...
                  <span className="truncate">Próxima reunião: {mentorshipData.nextSessionLabel}</span>
                </span>
              </div>
            ) : null}
          </div>
