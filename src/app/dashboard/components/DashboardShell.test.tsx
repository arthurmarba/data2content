...
describe("DashboardShell mobile strategic profile routing", () => {
  it("identifica as rotas do Perfil Estratégico mobile", () => {
    expect(isMobileStrategicProfileRoute(CREATOR_PROFILE_ROUTE)).toBe(true);
    expect(isMobileStrategicProfileRoute(`${CREATOR_PROFILE_ROUTE}/extra`)).toBe(true);
  ...
  it("identifica as entradas legadas que devem pular para o Perfil Estratégico no mobile", () => {
    ...
    expect(isMobileDashboardEntryRoute(CREATOR_PROFILE_ROUTE)).toBe(false);
