...
export interface IUser extends Document {
  ...
  onboardingAnswers?: {
    ...
    /** Declaração de propósito livre do criador — "para quem cria / o que quer que eles sintam". */
    creatorPurpose?: string | null;
  } | null;
  /** Weekly narrative map summary generated by GPT-4o-mini. */
  weeklyMapSummary?: string | null;
  /** When the weekly summary was last generated. */
  weeklyMapSummaryGeneratedAt?: Date | null;
  /**
   * When the weekly WhatsApp newsletter was last sent to this creator.
   * Written by the D2 cron after a successful sendTemplateMessage call.
   * Used as throttle gate (6-day minimum between sends).
   */
...
const userSchema = new Schema<IUser>(
  {
    ...
    /**
     * Last time the creator opened the narrative map.
    ...
    onboardingAnswers: {
      type: new Schema(
        {
          whyYouCreate: { type: String, default: null },
          desiredFeeling: { type: String, default: null },
          contentLimit: { type: String, default: null },
          creatorPurpose: { type: String, default: null },
        },
        { _id: false },
      ),
      default: null,
    ...
    /**
     * Weekly narrative map summary generated by GPT-4o-mini.
     * A short paragraph reflecting what the map revealed this week —
     * narrativa, territórios, próximo conteúdo — in mirror (not metric) language.
     */
    weeklyMapSummary: { type: String, default: null },
    /** When the weekly summary was last generated for this user. */
    weeklyMapSummaryGeneratedAt: { type: Date, default: null },
    /** When the weekly WhatsApp newsletter was last dispatched to this creator. */
