export function trialWelcomeEmail({
  ...
  const subject = "Você ganhou 48h no Plano Agência — aproveite agora";
  ...
  const intro = `${greeting}\n\nVocê acabou de liberar o Modo Agência da Data2Content por 48 horas. Durante esse período, além da comunidade aberta, você também tem acesso completo ao <Grupo VIP> — mentorias estratégicas semanais, salas reservadas e alertas premium no WhatsApp.`;
  ...
  const closing = `O acesso gratuito expira em ${formattedDate}. Aproveite para sentir o valor do Grupo VIP: mentorias semanais, acompanhamento do Mobi e alertas que mantêm você constante.\n\nBons conteúdos!\nEquipe Data2Content`;

  const text = `${intro}\n\nComece por aqui:\n${stepsText}\n\n• Abrir o painel: ${ctaUrl}\n• Ativar o WhatsApp IA: ${whatsappUrl}\n\n${closing}`;

  const html = `
  <p>${greeting}</p>
  <p>Você acabou de liberar o <strong>Modo Agência</strong> da Data2Content por 48 horas. Durante esse período, além da comunidade aberta, você também tem acesso completo ao <strong>Grupo VIP</strong>: mentorias estratégicas semanais, salas reservadas e alertas premium no WhatsApp.</p>
  <p>Comece por aqui:</p>
  <ul>
  ...
  <p style="font-size:13px;color:#555;">O acesso gratuito expira em <strong>${formattedDate}</strong>. Aproveite para sentir o valor do Grupo VIP: mentorias semanais, acompanhamento do Mobi e alertas que mantêm você constante.</p>
