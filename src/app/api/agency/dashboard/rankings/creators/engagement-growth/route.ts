...
// AVISO: A correção completa deste arquivo pode depender da atualização da função 'fetchEngagementVariationCreators'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const results = await fetchEngagementVariationCreators({ ...params, agencyId: session.user.agencyId } as any);
