...
export default function CollabsPinnedBoard({ showTitleMarker = true, isHighlighted = false, dedicatedView = false, embedded = false, compact = false, onBackToPerfil, onConnectWhatsApp, focusedTerritory }: {
  compact?: boolean; showTitleMarker?: boolean; isHighlighted?: boolean; dedicatedView?: boolean; embedded?: boolean;
