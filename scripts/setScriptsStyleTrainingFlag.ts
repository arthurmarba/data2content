...
const SCRIPT_TAG = "[SCRIPT_SET_SCRIPTS_STYLE_TRAINING_FLAG]";
const FLAG_KEY = "scripts_style_training_v1";
...
async function run() {
  ...
  const update: Record<string, any> = {
    description: "Treino incremental do estilo de roteiros por usuario (v1)",
  };
