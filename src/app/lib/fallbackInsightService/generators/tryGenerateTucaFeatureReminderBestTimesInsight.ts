...
/**
 * Tenta gerar um lembrete sobre a funcionalidade "melhores horários" do Mobi.
...
export async function tryGenerateTucaFeatureReminderBestTimesInsight(
    ...
    return {
        text: `Olá ${userNameForMsg}! Você sabia que aqui no Mobi eu posso te ajudar a descobrir os melhores horários para postar, analisando quando sua audiência está mais ativa? Se quiser otimizar o alcance dos seus próximos posts e aumentar as chances de engajamento, é só me perguntar sobre "melhores horários"! ⏰📊`,
